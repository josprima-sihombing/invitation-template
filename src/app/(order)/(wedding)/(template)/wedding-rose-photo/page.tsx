      ...
      >
        ...
        >
          ...
          <div className="relative px-16 pt-[100px] pb-[100px] h-full text-center flex flex-col">
            ...
            >
              ...
              >
                <h1 className={classNames(css.textShadow, "text-5xl")}>Asep</h1>
                <h2 className={classNames(css.textShadow, "text-4xl")}>&</h2>
                <h1 className={classNames(css.textShadow, "text-5xl")}>
                  Suharmi
                </h1>
              </div>
              <div>
                ...
                <h1 className="font-medium text-xl text-white mb-6">
        ...
        {isOpen && (
          <div className="relative" ref={invitationContentRef}>
            ...
            <div className="bg-[#EBC772] px-4 py-12">
              <h1
                className={classNames(
                  hirarkiSignatureFont.className,
                  "text-center text-3xl mb-8 text-[#7F0826]",
                )}
              >
                Our Moments
              </h1>
              ...
              <Carousel showIndicators showArrows infiniteLoop autoPlay>
                {galleryImages.map((imageUrl) => (
                  <div key={imageUrl} className="w-full h-[500px] bg-black">
                    <img
                      src={imageUrl}
